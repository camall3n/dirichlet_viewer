function varargout = dirichlet_viewer(varargin)
% DIRICHLET_VIEWER Dirichlet Distribution Visualizer
%      DIRICHLET_VIEWER, by itself, launches the visualizer.
%
%      The visualizer displays the PDF of the Dirichlet Distribution.
%
% See also: BETA_VIEWER

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dirichlet_viewer_OpeningFcn, ...
                   'gui_OutputFcn',  @dirichlet_viewer_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before dirichlet_viewer is made visible.
function dirichlet_viewer_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dirichlet_viewer (see VARARGIN)

% Choose default command line output for dirichlet_viewer
...
% UIWAIT makes dirichlet_viewer wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = dirichlet_viewer_OutputFcn(hObject, eventdata, handles) 
...
dirplot3(handles.alpha, handles.axes1, handles.axes2);
